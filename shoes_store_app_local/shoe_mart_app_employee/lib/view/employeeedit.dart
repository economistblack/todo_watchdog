...
class _EmployeeEditState extends State<EmployeeEdit> {
  ...
  void initState() {
    ...
    employeeNoController.text = value[0];
    passWordCheckController.text = value[1];
    nameController.text = value[2];
    dateController.text = value[3];
    positionController.text = value[4].toString();
    authorityController.text = value[5].toString();
    storeCode = value[6];
  }
